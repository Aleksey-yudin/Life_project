        ...
        {categories.map(category => (
          <ListItem key={category.id} secondaryAction={
            ...
            <ListItemText
              ...
              secondary={category.type === 'income' ? 'Доход' : 'Расход'}
            />
          </ListItem>
        ))}
      </List>
      ...
      <Dialog open={open} onClose={() => setOpen(false)}>
        ...
        <DialogContent>
          ...
          <FormControl fullWidth margin="dense">
            ...
            <Select value={type} label="Тип" onChange={e => setType(e.target.value as 'income' | 'expense')}>
              <MenuItem value="income">Доход</MenuItem>
              <MenuItem value="expense">Расход</MenuItem>
            </Select>
          </FormControl>
          <TextField margin="dense" label="Цвет (hex)" fullWidth value={color} onChange={e => setColor(e.target.value)} />
        </DialogContent>
        <DialogActions>
